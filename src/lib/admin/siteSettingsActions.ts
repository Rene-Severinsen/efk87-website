...
const publicHomepageSettingsSchema = z.object({
  publicHeroImageUrl: z.string().trim().nullable().optional(),
  publicHeroImageAltText: z.string().trim().nullable().optional(),
  publicHeroTitle: z.string().trim().nullable().optional(),
  publicHeroSubtitle: z.string().trim().nullable().optional(),
  publicHeroPrimaryCtaLabel: z.string().trim().nullable().optional(),
  publicHeroPrimaryCtaHref: z.string().trim().nullable().optional(),
  publicHeroSecondaryCtaLabel: z.string().trim().nullable().optional(),
  publicHeroSecondaryCtaHref: z.string().trim().nullable().optional(),
  publicHeroTertiaryCtaLabel: z.string().trim().nullable().optional(),
  publicHeroTertiaryCtaHref: z.string().trim().nullable().optional(),
  publicHeroQuaternaryCtaLabel: z.string().trim().nullable().optional(),
  publicHeroQuaternaryCtaHref: z.string().trim().nullable().optional(),
  publicIntroTitle: z.string().trim().nullable().optional(),
  publicIntroLinkLabel: z.string().trim().nullable().optional(),
  publicIntroLinkHref: z.string().trim().nullable().optional(),
  publicIntroCard1Icon: z.string().trim().nullable().optional(),
  publicIntroCard1Title: z.string().trim().nullable().optional(),
  publicIntroCard1Text: z.string().trim().nullable().optional(),
  publicIntroCard1Href: z.string().trim().nullable().optional(),
  publicIntroCard2Icon: z.string().trim().nullable().optional(),
  publicIntroCard2Title: z.string().trim().nullable().optional(),
  publicIntroCard2Text: z.string().trim().nullable().optional(),
  publicIntroCard2Href: z.string().trim().nullable().optional(),
  publicIntroCard3Icon: z.string().trim().nullable().optional(),
  publicIntroCard3Title: z.string().trim().nullable().optional(),
  publicIntroCard3Text: z.string().trim().nullable().optional(),
  publicIntroCard3Href: z.string().trim().nullable().optional(),
  publicCtaSectionTitle: z.string().trim().nullable().optional(),
  publicCtaSectionLinkLabel: z.string().trim().nullable().optional(),
  publicCtaSectionLinkHref: z.string().trim().nullable().optional(),
  publicCtaBoxIcon: z.string().trim().nullable().optional(),
  publicCtaBoxTitle: z.string().trim().nullable().optional(),
  publicCtaBoxText: z.string().trim().nullable().optional(),
  publicCtaPrimaryLabel: z.string().trim().nullable().optional(),
  publicCtaPrimaryHref: z.string().trim().nullable().optional(),
  publicCtaSecondaryLabel: z.string().trim().nullable().optional(),
  publicCtaSecondaryHref: z.string().trim().nullable().optional(),
});
...
export async function updatePublicHomepageSettingsAction(
  ...
  const parsed = publicHomepageSettingsSchema.safeParse({
    publicHeroImageUrl: formTextOrNull(formData, "publicHeroImageUrl"),
    publicHeroImageAltText: formTextOrNull(formData, "publicHeroImageAltText"),
  ...
  try {
    await updatePublicHomepageSettings(clubId, {
      publicHeroImageUrl: parsed.data.publicHeroImageUrl ?? null,
      publicHeroImageAltText: parsed.data.publicHeroImageAltText ?? null,
