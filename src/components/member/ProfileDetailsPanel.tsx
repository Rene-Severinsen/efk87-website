          ...
          <div className="profile-form-grid">
            ...
            <div className="profile-field">
              ...
              <input
                  ...
                  onChange={(event) => updateFormValue('mobilePhone', event.target.value)}
            ...
            <div className="profile-field full">
              ...
              <input
                  ...
                  onChange={(event) => updateFormValue('addressLine', event.target.value)}
            ...
            <div className="profile-field">
              ...
              <input
                  ...
                  onChange={(event) => updateFormValue('postalCode', event.target.value)}
            ...
            <div className="profile-field">
              ...
              <input
                  ...
                  name="mdkNumber"
                  type="text"
                  value={formValues.mdkNumber}
                  onChange={(event) => updateFormValue('mdkNumber', event.target.value)}
                  placeholder="Ikke oplyst"
                  readOnly={!isEditing}
              />
            </div>
            ...
            <div className="profile-field">
              ...
              {isEditing ? (
                  <input
                      ...
                      onChange={(event) => updateFormValue('birthDate', event.target.value)}
                  />
              ) : (
                  <input
                      id="birthDate"
