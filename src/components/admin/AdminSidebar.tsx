      ...
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <div className="admin-sidebar-group">
            ...
            <a
                href={`/${clubSlug}/admin/her-bor-vi`}
                className={`admin-sidebar-item ${pathname?.startsWith(`/${clubSlug}/admin/her-bor-vi`) ? "active" : ""}`}
            >
              Her bor vi
            </a>
          <a
          ...
          <a
                href={`/${clubSlug}/admin/footer`}
                className={`admin-sidebar-item ${pathname?.startsWith(`/${clubSlug}/admin/footer`) ? "active" : ""}`}
            >
              Footer
            </a>
<a
          ...
          <div className="admin-user-card">
            <div className="admin-user-card-main">
              ...
              <div className="admin-user-info">
                ...
                {userEmail ? <div className="admin-user-email">{userEmail}</div> : null}
              </div>
            </div>
