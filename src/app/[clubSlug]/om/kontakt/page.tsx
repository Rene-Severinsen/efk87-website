      ...
      {instructors.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          {instructors.map((instructor, index) => (
            <ThemedSectionCard key={index} className="flex flex-col h-full">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white leading-tight">{instructor.displayName}</h3>
                  ...
                  <p className="text-emerald-400 text-xs font-semibold uppercase tracking-wider mt-1">Instruktør</p>
                </div>
              </div>
              ...
              <div className="space-y-3 mt-auto">
                ...
                {instructor.mobilePhone && (
                  ...
                  >
                    ...
                    <span className="text-sm">{instructor.mobilePhone}</span>
                  </a>
                )}
              </div>
            </ThemedSectionCard>
