...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  return (
      ...
      >
        <div className="mt-6 mb-8 flex justify-start md:justify-end">
          <Link
              href={`${publicRoutes.forumCategory(clubSlug, categorySlug)}/ny`}
              className="public-primary-button inline-flex items-center justify-center gap-2 px-6 py-3"
          >
                          ...
                          <div className="flex items-start justify-between gap-4">
                            <div className="min-w-0 flex-1">
                              <div className="mb-1 flex min-w-0 items-center gap-2">
                                {thread.isPinned && (
                                    <span className="shrink-0 rounded-full border border-[var(--public-primary)] bg-[var(--public-primary-soft)] px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-[var(--public-primary)]">
                              Fastgjort
                            </span>
                                )}

                                <h3 className="truncate text-lg font-bold leading-tight text-[var(--public-text)] transition-colors group-hover:text-[var(--public-primary)]">
                                  {thread.title}
                                </h3>
                              </div>
                            </div>
